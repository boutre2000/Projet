...
const telecharger= (e) =>{
    e.preventDefault();
    axios.put(`http://localhost:4000/contrat/viewpj/${id}`, {responseType: 'blob'}, config)
    .then(dem=>{
    ...
    <form action="#">
      ...
      <div className="colone" style={{marginTop: '50px'}}>
           <fieldset >
            ...
            <button className="prevcbtntel" onClick={(e)=>{telecharger(e)}}><RiIcons.RiFileDownloadLine/> Télécharger</button>
