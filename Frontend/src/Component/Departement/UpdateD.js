...
function Update() {
    ...
    const fetchFCT = async () => {
      try {
        const req = await axios.get(
          `http://localhost:4000/dep/getone/${id}`,
          config
        );
  ...
  const handleSubmit = async (e) => {
    ...
    const dep = await axios.put(
      `http://localhost:4000/dep/edit/${id}`,
      { NomD, email },
      config
    );
  ...
  return (
    <div className="ajout">
      ...
      <form onSubmit={handleSubmit}>
        &nbsp; &nbsp; &nbsp;
        <label className="flab" htmlFor="fname">
          Nom du departement :
        </label>
        <br />
        <br />
        ...
        <br />
        &nbsp; &nbsp; &nbsp;
        <label className="llab" htmlFor="lname">
          Mail de responsable:
        </label>
        <br />
        <br />
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                Le département a bien été edité .
              </DialogContentText>
            </DialogContent>
            <DialogActions>
